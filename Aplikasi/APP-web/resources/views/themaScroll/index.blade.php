...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="{{ route('index') }}#hero" class="logo d-flex align-items-center me-auto">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="{{ route('index') }}#hero" class="">Home</a></li>
                    <li><a href="{{ route('index') }}#about">About</a></li>
                    <li><a href="{{ route('index') }}#book">Book</a></li>
                    </li>
                ...
                <div class="container">
                    <div class="row justify-content-md-center">
                        <div class="col-12 col-md-10">
                            <h2 class="mb-4 display-5 text-center font-size: 50px text-dark font-weight-bold">About</h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="200">
                            <!-- Poster 1 -->
                            <a href="{{ url('/login') }}" target="_blank" rel="noopener noreferrer" class="poster-link">
                                <div class="poster">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="600">
                        <a href="{{ url('/login') }}" target="_blank" rel="noopener noreferrer" class="poster-link">
                            <div class="poster">
                                <img src="./assets/img/book/Bulan1.png" class="img-fluid" alt="Bulan1">
                                <div class="info">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up" data-aos-delay="600">
                        <a href="{{ url('/login') }}" target="_blank" rel="noopener noreferrer" class="poster-link">
                            <div class="poster">
                                <img src="./assets/img/book/yangFanaadalahWaktu.png" class="img-fluid" alt="86">
                                <div class="info">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <ul class="list-unstyled pt-2">
                            <li class="py-1"><a href="#hero" class="text-light text-decoration-none">Home</a></li>
                            <li class="py-1"><a href="#about" class="text-light text-decoration-none">About</a></li>
                            <li class="py-1"><a href="#Contact" class="text-light text-decoration-none">Contact</a></li>
                        </ul>
                    </div>
                    <div class="col">
                        <h4>Book</h4>
